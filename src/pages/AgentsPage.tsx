  ...
  return (
    <div className="min-h-screen pb-28 page-enter">
      ...
      <div className="px-6 pt-14 pb-4 flex items-center justify-between">
        ...
        <span className="text-xs text-white/30">{agents.length} 个</span>
      </div>
          ...
          <EmptyState
            ...
            action={
              <button
                ...
                className="aurora-gradient text-white text-sm font-semibold px-6 py-3 rounded-2xl flex items-center gap-2 animate-bounce-soft"
              >
                <Plus size={18} />
                创建智能体
              </button>
            ...
            >
              ...
              <div className="flex items-center gap-1">
                <button
                  ...
                  className="p-2 rounded-xl hover:bg-white/10 transition-colors text-white/40 hover:text-white/70"
                >
                  <Pencil size={16} />
                </button>
                <button
                  onClick={(e) => handleDelete(e, agent)}
                  className="p-2 rounded-xl hover:bg-red-500/10 transition-colors text-white/40 hover:text-red-400"
                >
                  <Trash2 size={16} />
                </button>
              </div>
      ...
      {agents.length > 0 && (
        <button
          onClick={() => navigate('/agents/new')}
          className="fixed bottom-24 right-4 max-w-[480px] w-14 h-14 rounded-2xl aurora-gradient flex items-center justify-center shadow-lg shadow-aurora-blue/20 active:scale-90 transition-transform z-40"
